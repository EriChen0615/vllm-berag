...
class RequestOutput:
    ...
    Args:
        ...
        berag_info: BERAG-specific telemetry for the request, if present.
    """
    ...
    def __init__(
        ...
        *,
        ...
        berag_info: dict[str, Any] | None = None,
    ...
    def add(self, next_output: "RequestOutput", aggregate: bool) -> None:
        ...
        if next_output.berag_info is not None:
            self.berag_info = next_output.berag_info
